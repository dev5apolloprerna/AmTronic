                            ...
                            <div class="row">
                                <span>
                                    ...
                                    <label style="font-weight:400; margin-left:14px;">
                                        <input type="radio" name="gst_applicable" id="gst_yes" value="1" {{ (string) old('gst_applicable', (int) $quotation->gst_applicable) === '1' ? 'checked' : '' }} required> Yes
                                    </label>
                                    <label style="font-weight:400; margin-left:10px;">
                                        <input type="radio" name="gst_applicable" id="gst_no" value="0" {{ (string) old('gst_applicable', (int) $quotation->gst_applicable) === '0' ? 'checked' : '' }} required> No
                                    </label>
