...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .party-box { width:100%; border:1px solid #c02026; border-radius:2.6mm;
        ...
        .items-table {  border-collapse:separate; border-spacing:0; border:1px solid #c02026; border-radius:2.5mm; overflow:hidden; margin-bottom:2mm; }
        .items-table th { height:6.5mm; padding:1mm; color:#fff; background:#c02026; border-right:1px solid rgba(255,255,255,.5); font-size:12.5px; line-height:1.25; font-weight:700; text-align:center; vertical-align:middle; }
        ...
        .items-table tr.total-row td { background:#c02026; color:#fff; font-weight:800; font-size:11.3px; padding:1.5mm 1.6mm; border-top:1px solid #2f6d16; }
        ...
        .aw-label { color:#c02026; font-weight:700; font-size:9.8px; }
        .aw-value { font-size:11.3px; margin-top:0.6mm; }
        .declaration-title-row { margin-bottom:1mm; height:6.5mm; font-size:0; }
        .declaration-icon { display:inline-block; vertical-align:middle; width:6.5mm; height:6.5mm; line-height:6.5mm; border-radius:3.3mm; background:#c02026; color:#fff; text-align:center; font-weight:700; font-size:10px; }
